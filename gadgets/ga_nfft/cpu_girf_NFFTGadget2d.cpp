...
#include "cpu_girf_NFFTGadget2d.h"
#include "hoNDFFT.h"
...
cpu_girf_NFFTGadget2d::cpu_girf_NFFTGadget2d()
  : image_counter_(0)
{
}


int cpu_girf_NFFTGadget2d::process( GadgetContainerMessage<IsmrmrdReconData>* m1)
{
    std::cout << "\nIN CPU_GIRF_NFFT2D!\n" << std::endl;
...
GADGET_FACTORY_DECLARE(cpu_girf_NFFTGadget2d)
}
