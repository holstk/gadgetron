...
cpuNFFTGadget3d::cpuNFFTGadget3d()
  : image_counter_(0)
{
}


int cpuNFFTGadget3d::process( GadgetContainerMessage<IsmrmrdReconData>* m1)
{
    std::cout << "\nIN CPUNFFT3D!\n" << std::endl;
	...
	*/
        ...
        for (uint16_t loc=0; loc < LOC; loc++) {
		    ...
		    write_nd_array<std::complex<float> >(&chunk, "/home/karen/data/gadget_output/chunk.cplx");
		    ...
		    hoNDArray<std::complex<float> > samples_write(samples.get_dimensions(), (std::complex<float>*)samples.begin());
		    write_nd_array<std::complex<float> >(&samples_write, "/home/karen/data/gadget_output/samples.cplx");
		    ...
		    hoNDArray<std::complex<float> > image_write(image.get_dimensions(), (std::complex<float>*)image.begin());
		    /* WRITE */ write_nd_array<std::complex<float>>(&image_write, "/home/karen/data/gadget_output/image_from_plan.cplx");
		    ...
		    */
		    ...
		    //wprotectedrite_nd_array<std::complex<float> >(&image_out, "/home/holstk/data/gadget_output/im.cplx");
                    multiplyConj( image_out, image_out, image_out );    
		    //write_nd_array<std::complex<float> >(&image_out, "/home/holstk/data/gadget_output/im_multiply.cplx");
		    ...
		    //write_nd_array<std::complex<float> >(&output, "/home/holstk/data/gadget_output/output.cplx");               
...
GADGET_FACTORY_DECLARE(cpuNFFTGadget3d)
}
