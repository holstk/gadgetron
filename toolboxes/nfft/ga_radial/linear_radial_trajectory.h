#ifndef LINEAR_RADIAL_TRAJECTORY_H
#define LINEAR_RADIAL_TRAJECTORY_H
...
template <class T, unsigned int D> class LinearRadialTrajectory
{
public:
    //GATrajectory();
    //~GATrajectory();
...
#endif //LINEAR_RADIAL_TRAJECTORY_H
